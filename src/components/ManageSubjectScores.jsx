...
// ---------- New helpers for max / validation ----------
const getMaxFor = (scoringCriteria, term, field) => {
  const v = scoringCriteria?.[term]?.[field];
  return v === "" || v === undefined ? undefined : Number(v);
};

const isExceeded = (value, scoringCriteria, term, field) => {
  if (value === "" || value === null || value === undefined) return false;
  const max = getMaxFor(scoringCriteria, term, field);
            ...
            <table className="w-100">
              ...
              <tbody>
                {studentsInClass
                  ...
                  .map((student) => {
                    const sid = student.user.studentID;
                    const sScore = studentScores[student.user.studentID] || {};
                    const t1 = sScore.term_1 || {};
                    const t2 = sScore.term_2 || {};
                    const max_t1_indicator = getMaxFor(scoringCriteria, "term_1", "indicator");
                    const max_t1_during = getMaxFor(scoringCriteria, "term_1", "during");
                    const max_t1_final = getMaxFor(scoringCriteria, "term_1", "final");
                    const max_t2_indicator = getMaxFor(scoringCriteria, "term_2", "indicator");
                    const max_t2_during = getMaxFor(scoringCriteria, "term_2", "during");
                    const max_t2_final = getMaxFor(scoringCriteria, "term_2", "final");
                    return (
                      <tr
                        key={student.id}
                      ...
                      >
                        ...
                        <td className="text-center">
                          <ScoreInput onBlurExceeded={handleBlurExceeded}
                            ...
                            max={max_t1_indicator}
                            exceeded={isExceeded(t1.indicator, scoringCriteria, "term_1", "indicator")}
                          />
                        </td>
                        <td className="text-center">
                          <ScoreInput onBlurExceeded={handleBlurExceeded}
                            ...
                            max={max_t1_during}
                            exceeded={isExceeded(t1.during, scoringCriteria, "term_1", "during")}
                          />
                        </td>
                        <td className="text-center">
                          <ScoreInput onBlurExceeded={handleBlurExceeded}
                            ...
                            max={max_t1_final}
                            exceeded={isExceeded(t1.final, scoringCriteria, "term_1", "final")}
                          />
                        </td>
                        <td className="text-center">
                          <Form.Control
                        ...
                        <td className="text-center">
                          <ScoreInput onBlurExceeded={handleBlurExceeded}
                            ...
                            max={max_t2_indicator}
                            exceeded={isExceeded(t2.indicator, scoringCriteria, "term_2", "indicator")}
                          />
                        </td>
                        <td className="text-center">
                          <ScoreInput onBlurExceeded={handleBlurExceeded}
                            ...
                            max={max_t2_during}
                            exceeded={isExceeded(t2.during, scoringCriteria, "term_2", "during")}
                          />
                        </td>
                        <td className="text-center">
                          <ScoreInput onBlurExceeded={handleBlurExceeded}
                            ...
                            max={max_t2_final}
                            exceeded={isExceeded(t2.final, scoringCriteria, "term_2", "final")}
                          />
                        </td>
                        <td className="text-center">
                          <Form.Control
